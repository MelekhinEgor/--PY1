...
to_csv_file(OUTPUT_FILE, headers_list, data)  # вызываем функцию записи данных в csv файл

with open(OUTPUT_FILE) as output_f:  # открываем файл для чтения
    for line in output_f:
        print(line, end="")  # построчно печатаем открытый файл для проверки результата
# пустая строка
